...
public class Experience {
    public static void main(String[] args) {
        Experice_of_employee employee1 = new Experice_of_employee("Akhil", 50000, LocalDate.parse("2021-04-01"));
        Experice_of_employee employee2 = new Experice_of_employee("Johi", 70000, LocalDate.parse("2015-04-01"));
        Experice_of_employee employee3 = new Experice_of_employee("Virat", 50000, LocalDate.parse("2011-01-15"));
