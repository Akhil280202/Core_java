...
public class School_details {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Akhil", 15);
        Student student2 = new Student("Johi", 16);
        Student student3 = new Student("Brito", 16);
        Student student4 = new Student("Virat", 15);
        ...
        Teacher teacher1 = new Teacher("Marnus", "Maths");
        Teacher teacher2 = new Teacher("Pujara", "English");
        Teacher teacher3 = new Teacher("Smith", "Science");
